...
export default function StatGrid({ stats, openModal }) {
    ...
    return (
        <div className="relative mr-3">
            ...
            <div ref={scrollRef} className="overflow-x-auto scroll-smooth max-h-[300px]">
                        ...
                        >
                            {group.map((stat) => (
                                <div
                                    ...
                                    className="bg-white rounded-xl shadow p-4 relative cursor-pointer h-[120px]"
                                >
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <p className="text-sm text-gray-700 font-medium break-words whitespace-normal">
                                                {stat.label}
                                            </p>
